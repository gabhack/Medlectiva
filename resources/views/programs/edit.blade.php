            ...
            <form action="{{ route('programs.update', $program->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="nombre" name="nombre" type="text" value="{{ $program->nombre }}" required>

                    @if (empty($program->nombre))
                        <p class="text-gray-500 text-sm">Ingrese el nombre del programa.</p>
                    @endif
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="ciudad" name="ciudad" type="text" value="{{ $program->ciudad }}" required>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="pais" name="pais" type="text" value="{{ $program->pais }}" required>
                ...
                <div class="mb-4">
                    ...
                    <div>
                        <div>
                            <label>
                                <input type="checkbox" name="acepta_estudiantes_medicina" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="acepta_medicos_generales" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="acepta_residentes" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="acepta_fellows" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="acepta_especialistas" value="1"
                ...
                <div class="mb-4">
                    ...
                    <div>
                        <div>
                            <label>
                                <input type="checkbox" name="hace_consulta_externa" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="hace_procedimientos" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="hace_hospitalizacion" value="1"
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="hace_cirugia" value="1"
